...
class Maze(tk.Tk, object):
    ...
    def step(self, action, is_random):
        ...
        if not self.player.is_valid() or \
                ...
                self.observation[self.player.x, self.player.y, ENEMY_CHANNEL] != 0 or \
            ...
            elif self.observation[self.player.x, self.player.y, ENEMY_CHANNEL] != 0:
        ...
        if action == STOP:
            ...
            for i in range(0, 8, 2):
                reward += self._try_stop(self.player, i) * 3
    ...
    def _init_enemy(self):
        ...
        self.observation[self.enemy.x, self.enemy.y, ENEMY_CHANNEL] = 1
